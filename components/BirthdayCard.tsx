    ...
    <div className={`relative overflow-hidden p-5 md:p-6 rounded-[2rem] md:rounded-2xl shadow-lg border-2 ${employee.isToday ? 'border-[#FFB703] bg-white' : 'border-transparent bg-white'}`}>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6">
        ...
        <div className="flex-grow text-center md:text-left w-full">
          ...
          <button
            type="button"
            onClick={handleFelicitarClick}
            title="Abrir WhatsApp com mensagem de parabéns para o número cadastrado"
            className="w-full md:w-auto px-6 md:px-8 py-3.5 md:py-4 bg-[#74C69D] hover:bg-[#1B4332] text-white font-black uppercase tracking-[0.2em] text-[10px] md:text-xs rounded-2xl md:rounded-xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg active:scale-95"
          >
